    ...
    destination: (request, env) => {
      ...
      if (/Mobile|Android/.test(userAgent)) {
        ...
        switch(country) {
          ...
          case 'NZ': return '/offers/survey-vault-nz-m';
          case 'FR': return '/offers/survey-vault-fr-m';
          case 'ES': return '/offers/survey-vault-es-m';
          case 'IT': return '/offers/survey-vault-it-m';
          case 'IN': return '/offers/survey-vault-in-m';
          case 'BR': return '/offers/survey-vault-br-m';
          case 'MX': return '/offers/survey-vault-mx-m';
          case 'PH': return '/offers/survey-vault-ph-m';
          case 'NG': return '/offers/survey-vault-ng-m';
        ...
        switch(country) {
          ...
          case 'NZ': return '/offers/survey-vault-nz-d';
          case 'FR': return '/offers/survey-vault-fr-d';
          case 'ES': return '/offers/survey-vault-es-d';
          case 'IT': return '/offers/survey-vault-it-d';
          case 'IN': return '/offers/survey-vault-in-d';
          case 'BR': return '/offers/survey-vault-br-d';
          case 'MX': return '/offers/survey-vault-mx-d';
          case 'PH': return '/offers/survey-vault-ph-d';
          case 'NG': return '/offers/survey-vault-ng-d';
